...
public:
    ...
    void compile_shader(std::initializer_list<std::string> srcs, glm::uint& dest, GLenum type, std::string type_name) {
    ...
    std::string name;
    glm::uint id = 0;
    glm::uint vertex_id = 0;
    glm::uint geometry_id = 0;
    glm::uint fragment_id = 0;
    glm::uint compute_id = 0;
...
private:
    ...
    void check_validation(glm::uint shader) {
        GLint is_ok = 0;
    ...
    void check_shader_errors(glm::uint shader) {
        GLint is_ok = 0;
    ...
    void check_program_errors(glm::uint shader) {
        GLint is_ok = 0;
